        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              description="The Online Voting System is a Java-based application developed as part of my 3rd semester coursework. It demonstrates core Java concepts such as Object-Oriented Programming (OOP), classes, inheritance, and basic database integration. The project simulates a real-world voting process with secure user interaction."
